...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Player player1 = new Player(1, "KadricanEscobar", "Kadir Þükrü", "Gök",  new GregorianCalendar(2001,07,04).getTime(),"43349076398","Assassin's Creed");
		Player player2 = new Player(2, "1001GeceMasalý", "Ali", "Gök",new GregorianCalendar(1995,1,1).getTime(), "10000000", "Forza Horizon 4");
		baseUserManager.addPlayer(player2);
		System.out.println("");
